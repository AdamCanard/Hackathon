...
const column = document.getElementById("programList");
...
for (prog of programList) {
  let newDoc = document.getElementById(prog);
  newDoc.addEventListener("click", GetSemester());
  progEvent.push(newDoc);
}
...
function navigation() {
  ...
  // anchorElem.href = "temp.html";
  // anchorElem.id = program;
  // anchorElem.innerHTML = program;
  // anchorElem.classList.add("program");
  // column.append(anchorElem);
}

function GetSemester(e) {
  console.log(e);
}
